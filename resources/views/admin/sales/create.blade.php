            ...
            <div class="col-lg-12">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        <form class="" action="{{ route('addsalesitems')}}" method="POST">
                            @csrf
                            <div class="row">
                               <div class="col-lg-3">
                               ...
                               <div class="col-lg-3">
                                    <div class="position-relative form-group">
                                        <label for="customer_payable" class="">Payable</label>
                                        <input name="customer_payable" id="customer_payable" value="0" type="text" class="form-control">
                                    </div>
                                </div>
                               <div class="col-lg-3">
                                    <div class="position-relative form-group">
                                        <label for="sales_date" class="">Sales Date</label>
                                        <input name="sales_date" id="sales_date" placeholder="sales_date" type="text" class="form-control @error('sales_date') is-invalid @enderror">
