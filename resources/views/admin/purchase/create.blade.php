            ...
            <div class="col-lg-12">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        <form class="" action="{{ route('addpurchaseitems')}}" method="POST">
                            @csrf
                            <div class="row">
                               <div class="col-lg-3">
                               ...
                               <div class="col-lg-3">
                                    <div class="position-relative form-group">
                                        ...
                                        <input name="purchase_date" id="purchase_date" placeholder="purchase_date" type="text" class="form-control @error('purchase_date') is-invalid @enderror">
                              ...
                              <div class="col-md-3" style="    background: gainsboro;padding: 15px 7px;">
                                  ...
                                  <div class="row">
                                        ...
                                        <div class="position-relative form-group col-lg-5">
                                            <input name="vat_amount" id="vat_amount" value="0" type="text" class="form-control" onchange="orderBy()">
                                        </div>
                                  </div>
                                  <div class="row">
                                        <div class="position-relative form-group col-lg-4" style="text-align:right" >
                                        ...
                                        <div class="position-relative form-group col-lg-5">
                                            <input name="discount_amount" id="discount_amount" value="0" type="text" class="form-control" onchange="orderBy()">
                                        </div>
                                  </div>
                                  <div class="row">
                                        <div class="position-relative form-group col-lg-4" style="text-align:right">
                                        ...
                                        <div class="position-relative form-group col-lg-8">
                                            <input name="discount_note" id="discount_note" value="" type="text" class="form-control">
                                        </div>
                                  </div>
                                  <div class="row">
                                        <div class="position-relative form-group col-lg-4" style="text-align:right">
                                        ...
                                        <div class="position-relative form-group col-lg-8">
                                            <input name="total_payable" id="total_payable" value="0" type="text" class="form-control">
                                        </div>
                                  </div>
                                  <div class="row">
                                        <div class="position-relative form-group col-lg-4" style="text-align:right">
                                        ...
                                        <div class="position-relative form-group col-lg-8">
                                            <input name="total_paid" id="total_paid" value="0" type="text" class="form-control" onchange="orderPaid()">
                                        </div>
                                  </div>
                                  <div class="row">
                                        <div class="position-relative form-group col-lg-4" style="text-align:right">
                                        ...
                                        <div class="position-relative form-group col-lg-8">
                                            <input name="total_due" id="total_due" value="0" type="text" class="form-control">
                                        </div>
                                  </div>
                                </div>
                            </div>
                            
                            <button class="mt-1 btn btn-primary" style="text-align:right">Submit</button>
                        </form>
                    </div>
                </div>
            </div>
