            ...
            <div class="col-lg-12">
                <div class="main-card mb-3 card">
                    <div class="card-body">
                        ...
                        <form class="" action="{{ route('updatepurchaseitems')}}" method="POST">
                            @csrf

                            <div class="row">
                               <div class="col-lg-3">
                                    <div class="position-relative form-group">
                                        <label for="suplier_id" class="">Supplier Name</label>
                                        <select name="suplier_id" id="suplier_id" class="form-control @error('suplier_id') is-invalid @enderror" required="required">
                                         <option value="">Select Supplier</option>
                                         @foreach($registers as $reg)
                                            <option value="{{ $reg->id }}" {{ ($purchase->supllier_id ==  $reg->id) ? 'selected':''}}>{{ $reg->name }}</option>
                                          @endforeach
                                        </select>
                                        @error('suplier_id')
                               ...
                               <div class="col-lg-3">
                                    <div class="position-relative form-group">
                                        ...
                                        <input name="purchase_date" value="{{$purchase->purchase_date}}" id="purchase_date" placeholder="purchase_date" type="text" class="form-control @error('purchase_date') is-invalid @enderror">
                                    
                                        <input name="purchase_id" id="purchase_id" value="{{$purchase->id}}"  type="hidden">
                                    ...
                                    <div class="ibox-content" style="overflow:scroll; height: 370px;">
                                            <div class="table-responsive">
                                                ...
                                                <table id="table_row_delete" class="table table-bordered">
                                                    ...
                                                    <input type="hidden" class="form-control" id="rowCount" value="{{ $count = count($purchaseDetails); }}" />
                                                        @foreach($purchaseDetails as $key =>$pDetails)
                                                        <tr id="tr_{{$key + 1}}">
                                                            <td style="">{{$key + 1}}</td>
                                                            <td>
                              ...
                              <div class="col-md-3" style="    background: gainsboro;padding: 15px 7px;">
                                  ...
                                  <div class="row">
                                        ...
                                        <div class="position-relative form-group col-lg-8">
                                            <input name="sub_total" id="sub_total" value="{{$purchase->subTotal}}"type="text" class="form-control">
                                        </div>
                                  </div>
                                  <div class="row">
                                        <div class="position-relative form-group col-lg-4" style="text-align:right">
                                        ...
                                        <div class="position-relative form-group col-lg-3">
                                            <select style="width:;" id="vat_type" name="vat_type" class="form-control " onchange="orderBy()">
                                                <option value="1" {{ ($purchase->vat ==  1) ? 'selected':''}}>%</option>
                                                <option value="2" {{ ($purchase->vat ==  2) ? 'selected':''}}>BDT</option>
                                            </select>
                                        </div>
                                        <div class="position-relative form-group col-lg-5">
                                            <input name="vat_amount" id="vat_amount" value="{{$purchase->vat_amount}}" type="text" class="form-control" onchange="orderBy()">
                                        </div>
                                  </div>
                                  <div class="row">
                                        <div class="position-relative form-group col-lg-4" style="text-align:right" >
                                        ...
                                        <div class="position-relative form-group col-lg-3">
                                            <select style="width:;" id="discount_type" name="discount_type" class="form-control " onchange="orderBy()">
                                                <option value="1" {{ ($purchase->discount ==  1) ? 'selected':''}}>%</option>
                                                <option value="2" {{ ($purchase->discount ==  2) ? 'selected':''}}>BDT</option>
                                            </select>
                                        </div>
                                        <div class="position-relative form-group col-lg-5">
                                            <input name="discount_amount" id="discount_amount" value="{{$purchase->discount_amount}}" type="text" class="form-control" onchange="orderBy()">
                                        </div>
                                  </div>
                                  <div class="row">
                                        <div class="position-relative form-group col-lg-4" style="text-align:right">
                                        ...
                                        <div class="position-relative form-group col-lg-8">
                                            <input name="discount_note" id="discount_note" value="{{$purchase->discount_note}}" type="text" class="form-control">
                                        </div>
                                  </div>
                                  <div class="row">
                                        <div class="position-relative form-group col-lg-4" style="text-align:right">
                                        ...
                                        <div class="position-relative form-group col-lg-8">
                                            <input name="total_payable" id="total_payable" value="{{$purchase->total_amount}}" type="text" class="form-control">
                                        </div>
                                  </div>
                                  <div class="row">
                                        <div class="position-relative form-group col-lg-4" style="text-align:right">
                                        ...
                                        <div class="position-relative form-group col-lg-8">
                                            <input name="total_paid" id="total_paid" value="{{$purchase->payable_amount}}" type="text" class="form-control" onchange="orderPaid()">
                                        </div>
                                  </div>
                                  <div class="row">
                                        <div class="position-relative form-group col-lg-4" style="text-align:right">
                                        ...
                                        <div class="position-relative form-group col-lg-8">
                                            <input name="total_due" id="total_due" value="{{$purchase->total_amount - $purchase->payable_amount}}" type="text" class="form-control">
                                        </div>
                                  </div>
                                </div>
                            </div>
